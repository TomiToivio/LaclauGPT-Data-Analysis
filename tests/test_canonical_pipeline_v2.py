...
def test_postprocess_projects_typed_laclau_fields_and_keeps_generic_views():
    record = synthetic_record()
    summary = MultimodalSummaryProposal(summary="Synthetic summary", entities=["Synthetic Lab"])
    discourse = DiscourseProposal(
